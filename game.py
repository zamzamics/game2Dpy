...
class Game:
    ...
    def start_text(self):
        ...
        text = font.render('PESAWAT TEMPUR', True, 'blue')
        text_rect = text.get_rect(center=(s_width/2, s_height/2))
        screen.blit(text, text_rect)
 
        font2 = pygame.font.SysFont('Calibri', 20)
        text2 = font2.render('YOURNAME', True, 'white')
 ...
 #menambahkan nyawa
    ...
    def pause_text(self):
        font = pygame.font.SysFont('Calibri', 50)
        text = font.render('PAUS', True, 'white')
        text_rect = text.get_rect(center=(s_width/2, s_height/2))
        screen.blit(text, text_rect)
...
#jumlah nyawa yang hilang saat musuh menembak
